	...
	<form action='/staff' method='GET'>
		...
		<table class="table-bordered">
			...
			<tr>
				<th class="">氏名</th>
				<td class="row">
					<div class="col-xs-1"><input class="form-control" type="text" name="" size="10" maxlength="40" value="" placeholder="性"></div>
					<div class="hyphen"> </div>
					<div class="col-xs-1"><input class="form-control" type="text" name="" size="10" maxlength="40" value="" placeholder="名"></div>
				</td>
				<th class="">氏名（カナ）</th>
				<td class="row">
					<div class="col-xs-1"><input class="form-control" type="text" name="" size="10" maxlength="40" value="" placeholder="セイ"></div>
					<div class="hyphen"> </div>
					<div class="col-xs-1"><input class="form-control" type="text" name="" size="10" maxlength="40" value="" placeholder="メイ"></div>
				</td>
			</tr>
			<tr>
