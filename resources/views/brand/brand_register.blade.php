		...
		<table class="table-bordered">
			<tbody>
				...
				<tr>
					<th>ブランドコード</th>
					<td colspan="3">
						<div class="search_box"><input class="form-control" type="text" name="brand_code" value=""></div>
					</td>
				</tr>
				<tr>
					<th>ブランド名</th>
					<td colspan="3">
						<div class="search_box"><input class="form-control" type="text" name="brand_name" value=""></div>
					</td>
				</tr>
				<tr>
				<tr>
					<th>ブランド名（カナ）</th>
					<td colspan="3"><input class="form-control" type="text" name="brand_kana" size="40" maxlength="60" name="brand_kana" value=""></td>
				</tr>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="form-control" type="text" name="staff_id" size="40" maxlength="40" value=""></td>
				</tr>
				<tr>
